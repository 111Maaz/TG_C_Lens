      ...
      <div className="container mx-auto px-4 py-6">
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="text-center md:text-left">
            <p className="text-sm font-medium text-gray-800">T•G Crime Lens v1.0</p>
            <p className="text-xs text-gray-600">101 Maaz Ali</p>
          </div>
          ...
          <div className="text-center md:text-right">
            <p className="text-sm font-medium text-gray-800">Telangana Crime Dashboard</p>
            <p className="text-xs text-gray-600">© 2025 Telangana State Police Analytics Division</p>
          </div>
        </div>
      </div>
    </footer>
